...
(function(scope) {
  ...
  ClientJS.prototype = {
    ...
    getFingerprint: function() {
      ...
      var webGlPrint = this.getWebGlPrint();

      var key = userAgent + bar + screenPrint + bar + pluginList + bar + fontList + bar + localStorage + bar + sessionStorage + bar + timeZone + bar + language + bar + systemLanguage + bar + cookies + bar + canvasPrint + webGlPrint;
      var seed = 256;
    ...
    getCanvasPrint: function() {
      ...
      try {
        ...
        // return empty string if canvas elemcent not supported
        return "";
      }
